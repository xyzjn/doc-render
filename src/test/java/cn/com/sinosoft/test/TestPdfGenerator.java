package test.java.cn.com.sinosoft.test;
...
import main.java.cn.com.sinosoft.app.freemaker.HtmlGenerator;
import main.java.cn.com.sinosoft.app.pdf.PdfDocumentGenerator;
import main.java.cn.com.sinosoft.app.pdf.bean.OverseaVo;
import main.java.cn.com.sinosoft.app.pdf.exception.DocumentGeneratingException;
import main.java.cn.com.sinosoft.app.utils.ResourceLoader;
...
public class TestPdfGenerator extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		String logConfigPath = ResourceLoader.getPath("main/resources/log4j.properties");
	...
	public void test(String outputFile) throws DocumentGeneratingException {
		...
		// classpath 中模板路径
		String template = "test/resources/config/templates/overseaAssistance.html";
		// classpath 路径
